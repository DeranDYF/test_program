<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="/" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="/assets/img/pt/logo-pt.png" class="h-20 w-20">
            </span>
            <span class="demo menu-text fw-semibold" style="margin-left: -145px;">Test Programming</span>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header mt-5">
            <span class="menu-header-text" data-i18n="Menu Penjualan">Menu Penjualan</span>
        </li>
        <li class="menu-item {{ $menu =='customer' ? 'active': ''}}">
            <a href="{{ route('customer') }}" class="menu-link">
                <i class="menu-icon tf-icons ri-user-line"></i>
                <div data-i18n="Customer">Customer</div>
            </a>
        </li>
        <li class="menu-item {{ $menu =='barang' ? 'active': ''}}">
